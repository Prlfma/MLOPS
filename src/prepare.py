...
def main():
    parser = argparse.ArgumentParser(description="Prepare a Music Popularity data for Prediction model.")

    parser.add_argument("--data_input", type=str, default="data/raw/dataset.csv", help="Path to the raw dataset")
    parser.add_argument("--data_output", type=str, default="data/prepared/", help="Path to the save dict")
